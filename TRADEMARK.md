...
The name **NexOrbs**, its logo(s), icon(s), wordmarks,
and all related brand elements (collectively, the “Trademarks”)
are trademarks of **NexOrbs**.

This trademark policy exists to protect users, clients, and the
community from confusion and to ensure the NexOrbs brand is used
accurately, consistently, and fairly.

This policy applies independently of any open-source license
used for NexOrbs software projects.

---

## Relationship to Open Source Licenses

Unless otherwise stated, the source code published by NexOrbs
is licensed under the terms described in each repository’s
`LICENSE` file.

**The NexOrbs name, logo, and brand assets are NOT licensed**
under any open-source license.

Nothing in the code license grants permission to use the NexOrbs
trademarks.
...
You MAY use the NexOrbs trademarks without prior written permission
only in the following cases:

- Referring to an unmodified NexOrbs project or service
- Linking to an official NexOrbs repository or website
- Writing articles, tutorials, reviews, or educational content
- Showing screenshots or videos of unmodified NexOrbs products
- Listing NexOrbs as a dependency, integration, or compatibility
  reference (e.g., “Compatible with NexOrbs”)

All permitted use MUST:
- Be truthful and non-misleading
- Avoid implying endorsement, partnership, or sponsorship
- Use the trademarks exactly as provided, without alteration
...
- Use the NexOrbs name or logo in a product, service, or company name
- Use NexOrbs trademarks for commercial or promotional purposes
- Use NexOrbs branding in advertising or marketing materials
- Use NexOrbs trademarks on merchandise (stickers, apparel, etc.)
- Offer paid services, hosting, or consulting under the NexOrbs name
- Use modified, animated, recolored, or derivative logos
- Suggest official endorsement, certification, or affiliation
...
- Modify, distort, recolor, or recreate the NexOrbs logo
- Use partial elements of the logo or wordmark
- Use the trademarks in a way that causes confusion
- Use the trademarks in deceptive, illegal, or harmful contexts
- Incorporate the trademarks into another logo or brand
- Register domain names, social media accounts, or apps
  containing “NexOrbs” or confusingly similar variations
- Use NexOrbs trademarks in forks without clear differentiation

---

## Forks and Derivative Projects

Forks of NexOrbs open-source repositories are permitted under
the applicable open-source license.

However:

- Forks MUST use a different name and logo
- Forks MUST NOT present themselves as official NexOrbs projects
- Forks MUST clearly disclose that they are independent

Acceptable example:

> “This project is a fork of NexOrbs software and is not
> affiliated with or endorsed by NexOrbs.”

---

## Logo Usage Guidelines

When using approved NexOrbs logo assets:
...
Typing the word “NexOrbs” does NOT replace the logo unless explicitly
authorized.
...
When appropriate, include the following notice:
...
NexOrbs reserves the right to revoke permission to use its trademarks
at any time if such use violates this policy or may cause confusion,
misrepresentation, or harm to the NexOrbs brand.

---

## Contact

For trademark usage requests or questions, contact us
